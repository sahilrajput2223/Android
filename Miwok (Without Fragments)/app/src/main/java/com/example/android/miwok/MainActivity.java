...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        colorTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent openColorListIntent = new Intent(MainActivity.this, ColorsActivity.class);
                startActivity(openColorListIntent);
            }
        });
        ...
        phraseTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent openPhraseListIntent = new Intent(MainActivity.this, PhrasesActivity.class);
                startActivity(openPhraseListIntent);
            }
        });
